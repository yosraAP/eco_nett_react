...
import imgMenageBureau from '../../Assets/imgMenageBureau.jpg'
import imgEntretienMenager from '../../Assets/imgEntretienMenager.png'
...
const BureauPage = () => {
  ...
  return (
    <>
        ...
        <div className="divStyle">
          <div className="container-fluid residentiel-content">
            <div className="container col-xxl-8 col-md-10 mx-auto px-2 py-4 ">
              <h1 className="text-center fs-1 text-uppercase mt-5 mb-0 h1_about">{t('h1_bureau')}</h1>
      ...
      <div className="secDiv" id="bureauPage">
        <div class="px-4 py-5 text-center bg-body-tertiary">
          <div class="col-lg-5 mx-auto">
            <h3 class="p_residentiel mb-4">{t('h3_bureau')}</h3>
          </div>
        </div>
          ...
          <div className="row flex-lg-row-reverse align-items-center">
            ...
            <div className="col-12 col-sm-12 col-lg-6 order-2 order-lg-2">
              <div className="img-container">
                <img src={imgMenageBureau} className="zoom-effect mt-3" alt="" />
              </div>
            </div>
            <div className="col-lg-6 order-1 order-lg-2">
              <h2 className="fs-4 fw-normal text-uppercase title_Res p-2">{t('h2_bureau')} </h2>
              <p className="p_about mt-4">{t('P1_bureau')}</p>
              <p className="p_about mt-2">{t('P2_bureau')}</p>
              <div class="titleRes-box">
                <h3 className="fw-normal fs-4 p-2">{t('h3_bureau2')}</h3>
              </div>
            </div>
        ...
        <div className="bg-sec-title">
          <div class="px-4 py-5 text-center">
            <div class="col-lg-12 text-uppercase mx-auto">
              <h1 class="fs-2">{t('h1_repond_Question')}</h1>
            </div>
            <div class="col-lg-5 mx-auto">
      ...
      <div className="mx-auto col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center">
          ...
          <div className="col-12 col-sm-12 col-lg-6 order-2 order-lg-2">
            <div className="img-container">
              <img src={imgEntretienMenager} className="zoom-effect mt-3" alt="" />
            </div>
          </div>
          <div className="col-12 col-lg-6 order-1 order-lg-1">
            <h2 className="fs-4 fw-normal text-uppercase title_Res">{t('methodeseEntretienBureau')}</h2>
            <p className="p_about mt-2 p-2">{t('EngagezNous')}</p>
            <p className="p_about mt-2 p-2" >{t('Organisation')}</p>
            <div class="titleRes-box">
              <h3 className="fw-normal fs-4 p-2">{t('prix_entretienBureau')}</h3>
            </div>
          </div>
