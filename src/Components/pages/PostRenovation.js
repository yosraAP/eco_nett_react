...
import imgApresRenovation1 from '../../Assets/img2Commercial.jpg'
import imgApresRenovation2 from '../../Assets/imgApresRenovation2.jpg'
...
const PostRenovation = () => {
  ...
  return (
    <>
        ...
        <div className="divStyle">
          <div className="container-fluid residentiel-content">
            <div className="container col-xxl-8 col-md-10 mx-auto px-2 py-4 ">
              <h1 className="text-center fs-1 text-uppercase mt-5 mb-0 h1_about">{t('h1_postRenovation')}</h1>
      ...
      <div className="secDiv" id="apresRenovation">
        <div class="px-4 py-5 text-center bg-body-tertiary">
          <div class="col-lg-5 mx-auto">
            <h3 class="p_residentiel mb-4">{t('h3_postRenovation')}</h3>
          </div>
        </div>
          ...
          <div className="row flex-lg-row-reverse align-items-center">
            ...
            <div className="col-12 col-sm-12 col-lg-6 order-2 order-lg-2">
              <div className="img-container">
                <img src={imgApresRenovation1} className="zoom-effect mt-3" alt="" />
              </div>
            </div>
            <div className="col-lg-6 order-1 order-lg-2">
              <h2 className="fs-4 fw-normal text-uppercase title_Res p-2">{t('h2_serviceRenovation')}</h2>
              <p className="p_about mt-4">{t('p_sollicitezPostRenovation')}</p>
              <div class="titleRes-box">
                <h3 className="fw-normal fs-4 p-2">{t('h3_servicePostRenov')}</h3>
              </div>
            </div>
        ...
        <div className="bg-sec-title">
          <div class="px-4 py-5 text-center">
            <div class="col-lg-12 text-uppercase mx-auto">
              <h1 class="fs-2">{t('h1_contactPostRenov')}</h1>
            </div>
            <div class="col-lg-5 mx-auto">
      ...
      <div className="mx-auto col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center">
          ...
          <div className="col-12 col-sm-12 col-lg-6 order-2 order-lg-2">
            <div className="img-container">
              <img src={imgApresRenovation2} className="zoom-effect mt-3" alt="" />
            </div>
          </div>
          <div className="col-12 col-lg-6 order-1 order-lg-1">
            <h2 className="fs-4 fw-normal text-uppercase title_Res">{t('h2_techniciensQualifies')}</h2>
            <p className="p_about mt-2 p-4">{t('p_techniciensQualifies')}</p>
            <div class="titleRes-box">
              <h3 className="fw-normal fs-4 p-2">{t('h3_PostRenovation2')}</h3>
            </div>
          </div>
