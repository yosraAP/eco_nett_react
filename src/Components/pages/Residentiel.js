...
import './index.css';
import imgResidentiel from '../../Assets/imgResidentiel3.gif'
import imgResidentiel2 from '../../Assets/img2_page_residentiel.png'
...
const ResidentielPage = () => {
  ...
  return (
    <>
      ...
      <div className="secDiv" id="residentielPage">
        <div class="px-4 py-5 text-center bg-body-tertiary">
          <div class="col-lg-5 mx-auto">
            <h3 class="p_residentiel mb-4">{t('h3_residentielPage')}</h3>
          </div>
        </div>
        ...
        <div className="mx-auto col-xxl-8 px-4 py-5">
          <div className="row flex-lg-row-reverse align-items-center">
            ...
            <div className="col-lg-6">
              <h2 className="fs-4 fw-normal text-uppercase title_Res">{t('h2_residentielPage')} </h2>
              <p className="p_about mt-4">{t('p1_residentielPage')}</p>
              <p className="p_about mt-2">{t('p2_residentielPage')}</p>
              <p className="p_about mt-2">{t('p3_residentielPage')}</p>
              <div class="titleRes-box">
                <h3 className="fw-normal fs-4">{t('assuranceResponsabilite')}</h3>
              </div>
            </div>
            <div className="col-12 col-sm-12 col-lg-6">
              <div className="img-container">
                <img src={imgResidentiel} className="zoom-effect mt-3" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="secDiv mt-3 mb-3 p-3">
        <div className="mx-auto col-xxl-8 px-4 py-5">
          <div className="row flex-lg-row-reverse align-items-center">

            <div className="col-lg-7 order-1 order-lg-2">
              <h2 className="fs-4 fw-normal text-uppercase title_Res">{t('menageProfessionnels')}</h2>
              <p className="p_about mt-4">{t('SolliciteznosServices')}</p>
              <p className="p_about mt-2">{t('p_soumission')}</p>
              <p className="p_about mt-2">{t('P_demande')}</p>
              <div class="titleRes-box">
                <h3 className="fw-normal fs-4">{t('h3_contrat')} </h3>
              </div>
            </div>
            <div className="col-12 col-sm-12 col-lg-5">
              <div className="img-container">
                <img src={imgResidentiel2} className="zoom-effect mt-3" alt="" />
              </div>
            </div>
          </div>
        </div>
